          ...
          <Col lg={12} xs={24} sm={24}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-2xl mt-2">
                Fare : R {bus.fare * selectedSeats.length} 
              </h1>
              <hr />
              ...
              <StripeCheckout
                ...
                currency="ZAR"
                stripeKey="pk_test_51OHv4mC9zXiHp3c5Dt8B6ZN4ZOmlaXtLBO3X4QLJAsUd8LjBuNdt5CTFrN9hsmOsZX4HC6xjfyoAUw179UhhJyJc0036M8UVSP"
              >
                <button
